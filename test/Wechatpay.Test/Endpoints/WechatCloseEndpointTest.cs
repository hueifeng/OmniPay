...
{
    public class WechatCloseEndpointTest
    {
        ...
        private ILogger<WechatCloseEndpoint> logger = new LoggerFactory ().CreateLogger<WechatCloseEndpoint> ();
        IWeChatPayClient _client;
        private WechatCloseEndpoint _subject;
        ...
        [Fact]
        public void Process_close_path_should_return_close_result () {
            _context.Request.Method = "POST";
            var result = _subject.Process (_context);
            result.Should ().BeOfType<CloseResult> ();
        }
    }
}